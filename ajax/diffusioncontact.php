...
/**
 *       \file       htdocs/diffusionplans/ajax/diffusioncontact.php
 *       \brief      File to return Ajax response on diffusioncontact list request
 */
...
// Security check
if (!$user->hasRight('diffusionplans', 'diffusioncontact', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax diffusionplans/ajax/diffusioncontact.php");
