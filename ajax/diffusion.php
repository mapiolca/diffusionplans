...
/**
 *       \file       htdocs/diffusionplans/ajax/diffusion.php
 *       \brief      File to return Ajax response on diffusion list request
 */
...
// Security check
if (!$user->hasRight('diffusionplans', 'diffusion', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax diffusionplans/ajax/diffusion.php");
