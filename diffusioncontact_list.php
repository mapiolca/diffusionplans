...
/**
 *   	\file       diffusioncontact_list.php
 *		\ingroup    diffusionplans
 *		\brief      List page for diffusioncontact
 */
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'DiffusionContact';
	$objectlabel = 'DiffusionContact';
...
$title = $langs->trans("DiffusionContacts");
//$help_url = "EN:Module_DiffusionContact|FR:Module_DiffusionContact_FR|ES:Módulo_DiffusionContact";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/diffusionplans/diffusioncontact_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/diffusionplans/diffusioncontact_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, $object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendDiffusionContactRef";
$modelmail = "diffusioncontact";
$objecttmp = new DiffusionContact($db);
