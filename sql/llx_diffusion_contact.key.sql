...
--ALTER TABLE llx_diffusion_contact ADD CONSTRAINT llx_diffusion_contact_fk_field FOREIGN KEY (fk_field) REFERENCES llx_diffusionplans_myotherobject(rowid);
